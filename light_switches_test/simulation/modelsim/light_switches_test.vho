...
-- x1	=>  Location: PIN_C10,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- x2	=>  Location: PIN_C11,	 I/O Standard: 2.5 V,	 Current Strength: Default


ARCHITECTURE structure OF light_switches_test IS
SIGNAL gnd : std_logic := '0';
SIGNAL vcc : std_logic := '1';
SIGNAL unknown : std_logic := 'X';
